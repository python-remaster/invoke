...
def load_source(_: str, path: str) -> dict:
...
class Config(DataProxy):
    ...
    **Special class attributes**
    ...
    def global_defaults() -> dict:
        ...
        # /bin/sh; however users may configure run.shell quite easily, so...
        else:
            shell = "/bin/sh"
    ...
    def load_defaults(self, data: dict, merge: bool = True) -> None:
        """
    ...
    def load_overrides(self, data: dict, merge: bool = True) -> None:
        """
    ...
    def load_collection(self, data: dict, merge: bool = True) -> None:
        """
    ...
    def _load_py(self, path: str) -> dict:
        data = {}
...
def copy_dict(source: dict) -> dict:
    """
...
def excise(dict_: dict, keypath: tuple[str, ...]) -> None:
    """
...
def obliterate(base: dict, deletions: dict) -> None:
    """
